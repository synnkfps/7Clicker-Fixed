...
public class ClickerGui {
	...
	public JLabel dropdownArrow = new JLabel(
			new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/arrow_down.png"))));
	public JLabel powerButton = new JLabel(
			new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/power_button.png"))));
	...
	private void setupFrame() {
		...
		frame.setIconImage(new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/7Clicker.png"))).getImage());
			...
			public void mousePressed(MouseEvent e) {
				if (frame.getHeight() == WINDOW_HEIGHT) {
					dropdownArrow.setIcon(
							new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/arrow_up.png"))));
	...
	private void setupSettings() {
		...
		overlayBox.setIcon(
				new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/checkbox_unchecked.png"))));
		overlayBox.setSelectedIcon(
				new ImageIcon(Objects.requireNonNull(AutoClicker.class.getClassLoader().getResource("assets/checkbox_checked.png"))));
